        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item align-self-center">
              <a href="login.php" class="btn px-4 btn-secondary ml-5 logintombol" style="background-color: #ffc0cb" >Log In</a>
            </li>
            <li class="nav-item align-self-center ">
              <a class="btn px-4 btn-primary ml-2 registombol" href="register.php" role="button" style="background-color: #ffc0cb"
              >Register</a>
            </li>
